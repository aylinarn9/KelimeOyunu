...
class Direk5Kanal : AppCompatActivity() {
    private lateinit var recyclerView: RecyclerView
    private lateinit var userArrayList: ArrayList<DirekOyuncu5>
    private lateinit var myAdapter: MyAdapterDirek5
    private lateinit var db: FirebaseFirestore
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_direk5_kanal)
        ...
        myAdapter= MyAdapterDirek5(userArrayList)
        ...
        myAdapter.setOnItemClickListener(object : MyAdapterDirek5.OnItemClickListener {
            override fun onItemClick(position: Int) {
                val clickedItem: DirekOyuncu5 = userArrayList[position]
    ...
    private fun oyundaguncelleme(position: Int) {
        val player: DirekOyuncu5 = userArrayList[position]
    ...
    private fun  oyunodasioyuncularilistele(documentId:String,girisyapankullanici:String){
        ...
        db.collection("oyunOdaları").document(documentId).collection("oyuncular").addSnapshotListener(object:
                    ...
                    if(dc.type== DocumentChange.Type.ADDED){
                        ...
                        kullaniciAdi?.let {
                            if (!userArrayList.any { oyuncu -> oyuncu.kullaniciadi == it }) {
                                ...
                                val oyuncu = dc.document.toObject(DirekOyuncu5::class.java)
